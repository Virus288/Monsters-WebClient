...
export const Label = styled(motion.h2)<localTypes.IDefaultComponentProps>`
  font-size: 1.1rem;
  display: inline-block;
  margin-right: 1rem;
`;

export const Form = styled(motion.form)<localTypes.IDefaultComponentProps>`
  display: flex;
...
export const Select = styled(motion.select)<localTypes.IDefaultComponentProps>`
  min-width: 200px;
  max-width: 300px;
  border: none;
  outline: none;
