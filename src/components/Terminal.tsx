...
import { useCounterStore,useAccountStore,useHistoryStore } from "../zustand/store";
  ...
  (props: TerminalProps, ref: ForwardedRef<HTMLDivElement>) => {
    ...
    const handleInputKeyDown = (e) => {
      if (e.key === "Enter") {
        ...
        const isCommandValid = avalibleCommandList.includes(
        ...
        if (!isCommandValid) {
          ...
          // const newConsoleOutput = commands[input] || "Invalid Command";
          pushToHistory(input);
          setInputValue("");
        }
      }
